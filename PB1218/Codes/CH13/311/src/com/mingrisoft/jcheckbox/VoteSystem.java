...
public class VoteSystem extends JFrame {
    ...
    public VoteSystem() {
        ...
        JButton submitButton = new JButton("´£¥æ");
        submitButton.setFont(new Font("·L³n¶®¶Â", Font.PLAIN, 16));
        ...
        JButton refreshButton = new JButton("¨ê·s");
        refreshButton.setFont(new Font("·L³n¶®¶Â", Font.PLAIN, 16));
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)), "¿ï¾Ü±z¾Õªøªº»y¨¥", TitledBorder.LEADING, TitledBorder.TOP, null,
                new Color(59, 59, 59)));
        ...
        checkBox1 = new JCheckBox("Java¡G ");
        checkBox1.setFont(new Font("·L³n¶®¶Â", Font.PLAIN, 14));
        ...
        progressBar1.setFont(new Font("·L³n¶®¶Â", Font.PLAIN, 14));
        ...
        checkBox2 = new JCheckBox("Perl¡G  ");
        checkBox2.setFont(new Font("·L³n¶®¶Â", Font.PLAIN, 14));
        ...
        progressBar2.setFont(new Font("·L³n¶®¶Â", Font.PLAIN, 14));
        ...
        checkBox3 = new JCheckBox("Ruby¡G");
        checkBox3.setFont(new Font("·L³n¶®¶Â", Font.PLAIN, 14));
        ...
        progressBar3.setFont(new Font("·L³n¶®¶Â", Font.PLAIN, 14));
        ...
        checkBox4 = new JCheckBox("Logo¡G");
        checkBox4.setFont(new Font("·L³n¶®¶Â", Font.PLAIN, 14));
        panel4.add(checkBox4, BorderLayout.WEST);
        
        label4 = new JLabel("0²¼");
        label4.setFont(new Font("·L³n¶®¶Â", Font.PLAIN, 14));
        panel4.add(label4, BorderLayout.EAST);
        
        progressBar4 = new JProgressBar();
        progressBar4.setStringPainted(true);
        progressBar4.setFont(new Font("·L³n¶®¶Â", Font.PLAIN, 14));
