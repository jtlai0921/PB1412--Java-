...
public class InsertBookFrame extends JFrame {    
    ...
    public InsertBookFrame() {
        ...
        setTitle("在增加資料時過濾到危險字符");
        JLabel lmessageLabel = new JLabel("向圖書銷售表中增加資料：");
        lmessageLabel.setFont(new Font("微軟雅黑", Font.PLAIN, 14));
        lmessageLabel.setBounds(114, 23, 193, 15);
        contentPane.add(lmessageLabel);
        
        JLabel nameLabel = new JLabel("圖書名稱：");
        ...
        JLabel stockLabel = new JLabel(" 函數庫 存：");
        ...
        JLabel pricLlabel = new JLabel(" 單 價：");
