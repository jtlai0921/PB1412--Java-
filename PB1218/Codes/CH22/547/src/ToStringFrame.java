...
public class ToStringFrame extends JFrame {
    ...
    public ToStringFrame() {
        ...
        setTitle("將愛好以字串的形式儲存到資料函數庫中");
        JPanel panel = new JPanel();
        panel.setBounds(0, 0, 380, 222);
        contentPane.add(panel);
        panel.setLayout(null);
        
        checkBox  = new JCheckBox("旅遊");
        ...
        JButton insertButton = new JButton("儲存");
        ...
        JLabel loveLabel = new JLabel("愛好：");
