...
public class SubjoinFrame extends JFrame {
    ...
    public SubjoinFrame() {
        ...
        JLabel nameLabel = new JLabel("資料函數庫名稱：");
        ...
        JLabel databasLlabel = new JLabel("資料函數庫檔案地址：");
        ...
        JLabel logLabel = new JLabel("日誌檔案地址：");
        ...
        JButton brownButton = new JButton("瀏覽");
        ...
        JButton logBrowButton = new JButton("瀏覽");
        ...
        JButton subjoinButton = new JButton("附加資料函數庫");
    ...
    protected void do_subjoinButton_actionPerformed(ActionEvent arg0) {
        ...
        if ((!namePath.equals("")) && (!dataName.equals(""))
            ...
            JOptionPane.showMessageDialog(getContentPane(), 
                    "資料附加成功！", "資訊提示框", JOptionPane.WARNING_MESSAGE);
        }
    }
}
