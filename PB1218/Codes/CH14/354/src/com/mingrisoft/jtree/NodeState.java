...
public class NodeState extends JFrame {
    ...
    protected void do_tree_valueChanged(TreeSelectionEvent e) {
        ...
        sb.append("該節點的子節點個數：" + node.getChildCount() + "\n");
        sb.append("該節點在樹中的階層：" + node.getLevel() + "\n");
        sb.append("該節點後代的葉子數：" + node.getLeafCount() + "\n");
        sb.append("該節點是否是根節點：" + node.isRoot() + "\n");
        sb.append("該節點是否是葉子節點：" + node.isLeaf() + "\n");
