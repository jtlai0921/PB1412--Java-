...
public class DiamondFrame extends JFrame {
    ...
    protected void do_this_windowOpened(WindowEvent e) {
        int[] xPoints = { 0, 50, 350, 400, 200, 0 };// 定義各頂點的X座標
        int[] yPoints = { 200, 100, 100, 200, 400, 200 };// 定義各頂點的Y座標
        Polygon polygon = new Polygon(xPoints, yPoints, 6);// 建立多邊形
        AWTUtilities.setWindowShape(this, polygon);// 設定窗體形狀
    }
