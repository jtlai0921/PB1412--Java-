...
public class ImageViewer extends JFrame {
    ...
    public ImageViewer() {
        ...
        button3.setFont(new Font("·L³n¶®¶Â", Font.PLAIN, 16));
        ...
        button4.setFont(new Font("·L³n¶®¶Â", Font.PLAIN, 16));
        ...
        button5.setFont(new Font("·L³n¶®¶Â", Font.PLAIN, 16));
        ...
        button6.setFont(new Font("·L³n¶®¶Â", Font.PLAIN, 16));
