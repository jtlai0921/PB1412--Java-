...
public class UnsynchronizedBankFrame extends JFrame {
	...
	public UnsynchronizedBankFrame() {
		...
		JButton startButton = new JButton("¶}©l¦s¿ú");
		...
		JLabel thread1Label = new JLabel("t1");
		thread1Label.setFont(new Font("·L³n¶®¶Â", Font.PLAIN, 16));
		...
		thread1TextArea.setFont(new Font("·L³n¶®¶Â", Font.PLAIN, 16));
		...
		JLabel thread2Label = new JLabel("t2");
		thread2Label.setFont(new Font("·L³n¶®¶Â", Font.PLAIN, 16));
		...
		thread2TextArea.setFont(new Font("·L³n¶®¶Â", Font.PLAIN, 16));
