...
public class StopThreadTest extends JFrame {
    ...
    public StopThreadTest() {
        ...
        lbljava = new JLabel("Java Book Update 21 Times");
        lbljava.setFont(new Font("微軟雅黑", Font.PLAIN, 16));
        panel1.add(lbljava);
    ...
    private class CounterThread implements Runnable {
        ...
        public void run() {
            while (stopped) {
                ...
                lbljava.setText("《Java編程詞典》第" + (count++) + "次更新！");
            }
        }
    }
    ...
    protected void do_button2_actionPerformed(ActionEvent e) {
        if (counter == null) {
            JOptionPane.showMessageDialog(this, "先執行線程", "", JOptionPane.WARNING_MESSAGE);
            return;
        }
