...
public List getOrderDesc() {
    ...
    try {
        ...
        String sql = "select * from tb_student order by chinese  desc limit 0,3"; //定義查詢資料表中前3條記錄的SQL敘述
    ...
    public static void main(String[] args) { 
        ...
        System.out.println("查詢語文成績排在前3名的同學：");
        for(int i = 0;i<list.size();i++){
            Student student = (Student)list.get(i);
            System.out.println("編號為："+student.getId()+"，姓名："+student.getName()+"，性別："+student.getSex()+
                    "，語文成績："+student.getChinese());
        }
    }
}
