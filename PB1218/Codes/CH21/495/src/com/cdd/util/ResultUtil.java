...
public List getGradeDesc() {
    ...
    try {
        ...
        String sql = "select top 3 id ,name,english from tb_Grade order by english"; // �w�q�N�ϮѪ����T�i��ƧǪ�SQL�ԭz
    ...
    public static void main(String[] args) {
        ...
        System.out.println("�^�y���Z�Ʀb��3���P�ǬO�G");
        for (int i = 0; i < list.size(); i++) {
            Grade grade = (Grade) list.get(i);
            System.out.println("�s���G" + grade.getId() + " �A�m�W�G"
                    + grade.getName() + "  �A�^�y���Z�G" + grade.getEnglish());
        }
    }
